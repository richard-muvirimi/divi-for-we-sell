    ...
    <div id="page-container" <?php echo et_core_intentionally_unescaped($page_container_style, 'fixed_string'); ?>>
        ...
        <div id="top-header" <?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
            <div class="container clearfix">
                ...
                <div id="et-info">
                    ...
                    <span id="et-info-phone"><a
                            href="<?php echo esc_attr('tel:' . $et_phone_number); ?>"><?php echo et_core_esc_previously(et_sanitize_html_input_text($et_phone_number)); ?></a></span>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    &nbsp;
                    <a href="http://webgems.co.zw/wesell/terms-conditions/">Terms &amp; Conditions</a>
                    &nbsp;
                    <a href="http://webgems.co.zw/wesell/company-profile/">Company Profile</a>
                    &nbsp;
                    <a href="http://webgems.co.zw/wesell/contact-us/">Contact us</a>
                    &nbsp;
                    <?php
        ...
        <header id="main-header" data-height-onload="<?php echo esc_attr(et_get_option('menu_height', '66')); ?>">
            <div class="container clearfix et_menu_container">
                ...
                <div>
                    <div class="rm_search_container">
                        <form role="search" method="get" class="" action="<?php echo esc_url(home_url('/')); ?>">
                            <?php
							printf(
								'<input id="rm_search" type="search" class="" placeholder="%1$s" value="%2$s" name="s" title="%3$s" />',
								esc_attr__('Search &hellip;', 'Divi'),
								get_search_query(),
								esc_attr__('Search for:', 'Divi')
							);
