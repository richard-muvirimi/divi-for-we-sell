...
$tn_stacked_header='stacked' === et_get_option('header_style', 'left');
        ...
        <header id="main-header" data-height-onload="<?php echo esc_attr(et_get_option('menu_height', '66')); ?>">
            ...
            <div id="tn-stacked-menu-container">
                <div class="container clearfix tn_menu_container">
                    <div class="tn-logo-and-secondary-menu-container clearfix">
                        <?php
			...
			echo et_core_intentionally_unescaped(apply_filters('et_html_top_header', $top_header), 'html');
			?>
                            <div id="tn-search-form-container" class="clearfix">
                                <form role="search" method="get" class="et-search-form"
                                    action="<?php echo esc_url(home_url('/')); ?>">
                                    <?php
						printf(
                    ...
                    <div class="tn_primary_menu clearfix">
